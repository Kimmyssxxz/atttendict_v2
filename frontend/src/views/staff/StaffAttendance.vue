  ...
  const todayLogs = computed(() => {
    ...
    if (currentAttendance.timeInAM) {
      logs.push({
        ...
        statusOut: currentAttendance.staffStatusOutAM || currentAttendance.staffStatusAM || currentAttendance.statusAM,
    ...
    if (currentAttendance.timeInPM) {
      logs.push({
        ...
        statusOut: currentAttendance.staffStatusOutPM || currentAttendance.staffStatusPM || currentAttendance.statusPM,
    ...
    todayLogs.value.forEach(log => {
      ...
      if (log.timeOut) {
        displayLogs.push({
          ...
          type: 'time-out',
          time: log.timeOut,
          status: log.statusOut || log.status,
